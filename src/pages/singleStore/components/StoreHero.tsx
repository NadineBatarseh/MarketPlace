...
export default function StoreHero({ store, loading, error }: Props) {
  ...
  const establishedYear = store?.created_at
  ...
  return (
    <section className="store-hero">
      ...
      <div className="store-info">
        {loading ? (
          <div className="store-name" style={{ color: 'var(--muted)' }}>جاري التحميل...</div>
        ) : error ? (
          <div className="store-name" style={{ color: 'var(--accent)' }}>{error}</div>
        ) : (
          <>
