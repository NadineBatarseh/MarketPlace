...
type DashPage = 'home' | 'reviews' | 'billing' | 'editPage' | 'bulkUpload' | 'orders' | 'drafts' | 'settings' | 'shopSettings' | 'instagramConnect' | 'inbox';
...
export default function MerchantDashboard() {
  ...
  const [currentPage, setCurrentPage] = useState<DashPage>(() => {
    ...
    const valid: DashPage[] = ['home', 'reviews', 'billing', 'editPage', 'bulkUpload', 'orders', 'drafts', 'settings', 'shopSettings', 'instagramConnect', 'inbox'];
